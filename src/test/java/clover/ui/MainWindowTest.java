...
class MainWindowTest {
    ...
    void addForestSpriteReaction_responseStyles_returnsMatchingShortReaction() {
        assertEquals("A new study quest has taken root! Task added", MainWindow.addForestSpriteReaction(
                "Task added", CommandResponseStyle.TASK_ADDED));
        assertEquals("A new learning companion has arrived in the grove. Learner added",
                MainWindow.addForestSpriteReaction("Learner added", CommandResponseStyle.TUTOREE_ADDED));
        assertEquals("The grove celebrates your progress! Task completed", MainWindow.addForestSpriteReaction(
                "Task completed", CommandResponseStyle.TASK_MARKED));
        assertEquals("This trail has been cleared from our grove. Task removed", MainWindow.addForestSpriteReaction(
