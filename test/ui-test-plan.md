...
**Expected behaviour:** Clover opens a 400 by 600 FXML-based JavaFX window with the Part 3 interactive chat layout and exits cleanly when the window is closed.
